    ...
    var ChineseDistricts = {
            86: {
                ...
                'T-Z': [
                 ...
                 '海外':[
                	 {code: '32', address: '阿根廷'},
                	 {code: '36', address: '澳大利亚'},
                	 {code: '50', address: '孟加拉国'},
                	 {code: '76', address: '巴西'},
                	 {code: '104', address: '缅甸'},
                	 {code: '124', address: '加拿大'},
                	 {code: '250', address: '法国'},
                	 {code: '276', address: '德国'},
                	 {code: '360', address: '印度尼西亚'},
                	 {code: '484', address: '墨西哥'},
                	 {code: '586', address: '巴基斯坦'},
                	 {code: '608', address: '菲律宾'},
                	 {code: '643', address: '俄罗斯'},
                	 {code: '704', address: '越南'},
                	 {code: '764', address: '泰国'},
                	 {code: '804', address: '乌克兰'},
                	 {code: '840', address: '美国'},
                	 {code: '999', address: '其它'}]
